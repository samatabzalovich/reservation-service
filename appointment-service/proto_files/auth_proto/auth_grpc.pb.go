...
const (
	TokenService_CreateAuthenticationToken_FullMethodName = "/auth.TokenService/CreateAuthenticationToken"
)
...
func (c *tokenServiceClient) CreateAuthenticationToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, TokenService_CreateAuthenticationToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TokenService_CreateAuthenticationToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TokenService_CreateAuthenticationToken_FullMethodName,
	}
...
func (c *smsServiceClient) ActivateUser(ctx context.Context, in *SmsRequest, opts ...grpc.CallOption) (*TokenResponse, error) {
	out := new(TokenResponse)
	err := c.cc.Invoke(ctx, SmsService_ActivateUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SmsService_ActivateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SmsService_ActivateUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	RegService_Register_FullMethodName = "/auth.RegService/Register"
)
...
type AuthServiceClient interface {
	...
	DeleteUser(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*RegResponse, error)
}
...
func (c *authServiceClient) DeleteUser(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*RegResponse, error) {
	out := new(RegResponse)
...
type AuthServiceServer interface {
	...
	DeleteUser(context.Context, *AuthRequest) (*RegResponse, error)
...
func (UnimplementedAuthServiceServer) DeleteUser(context.Context, *AuthRequest) (*RegResponse, error) {
...
func _AuthService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DeleteUser(ctx, req.(*AuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
